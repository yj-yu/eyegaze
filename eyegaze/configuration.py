...
VAS_DATA_PATH = os.path.normpath(os.path.join(__path__, "/data1/common_datasets/VAS"))
...
class ModelConfig(object):
    ...
    def __init__(self):
        ...
        if self.dataset_name == "VAS":
            self.input_file_pattern = os.path.join(VAS_DATA_PATH, "TFRecord/VAS/train-????-of-0100")
        else:
        ...
        self.inception_checkpoint_file = "/data1/common_datasets/VAS/PretrainedModules/inception_v3.ckpt"
        self.c3d_checkpoint_file = "/data1/common_datasets/VAS/PretrainedModules/sports1m_finetuning_ucf101.model"
        self.c3d_mean_file = "/data1/common_datasets/VAS/PretrainedModules/c3d_mean.npy"
